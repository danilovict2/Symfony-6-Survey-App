        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 text-gray-700">
            ...
            <DashboardCard class="order-3 lg:order-1 row-span-2" style="animation-delay: 0.2s">
                ...
                <div v-if="data.latestSurvey">
                    <img :src="`/uploads/photos/${data.latestSurvey.image}`" class="w-[240px] mx-auto" alt="" />
                    ...
                    <div class="flex justify-between">
                        <TButton :href="`/survey/${data.latestSurvey.id}`">
            ...
            <DashboardCard class="order-4 lg:order-3 row-span-2" style="animation-delay: 0.3s">
                ...
                <div v-if="data.latestAnswers.length" class="text-left">
                    <a href="#" v-for="answer of data.latestAnswers" :key="answer.id"
                        ...
                        <small>
                            Answer Made at:
                            <i class="font-semibold">{{ answer.start_date }}</i>
                        </small>
                    </a>
                </div>
                <div v-else class="text-gray-600 text-center py-16">
