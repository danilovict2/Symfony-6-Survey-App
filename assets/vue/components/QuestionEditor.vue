<template>
    ...
    <div class="grid gap-3 grid-cols-12">
        ...
        <div class="mt-3 col-span-9">
            <label :for="'question_text_' + question.data" class="block text-sm font-medium text-gray-700">Question
                Text</label>
            <input type="text" :name="'question_text_' + question.data" v-model="question.question" @change="dataChange"
        ...
        <div class="mt-3 col-span-3">
            ...
            <select id="question_type" name="question_type" v-model="question.type" @change="typeChange"
    ...
    <div class="mt-3 col-span-9">
        <label :for="'question_description_' + question.id"
            class="block text-sm font-medium text-gray-700">Description</label>
        <textarea :name="'question_description_' + question.id" v-model="question.description" @change="dataChange"
    ...
    <div>
        <div v-if="shouldHaveOptions()" class="mt-2">
            ...
            <div v-if="!question.data.options.length" class="text-xs text-gray-600 text-center py-3">
                You don't have any options defined
            </div>
            <!-- Option list -->
            <div v-for="(option, index) in question.data.options" :key="option.uuid" class="flex items-center mb-1">
...
const questionTypes = computed(() => ["text", "select", "radio", "checkbox", "textarea"]);
...
function shouldHaveOptions() {
    return ["select", "radio", "checkbox"].includes(question.value.type);
}
